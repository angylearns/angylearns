<main class="container">
    ...
    <section>
        ...
        <br><br>
        <strong>Now</strong> I'm immersed in my education and professional development and working as a Software Engineering Trainee, so all the code I write is not in these repositories but somewhere else. Always learning!
        <br><br>
